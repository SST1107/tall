...
height_female.append('line').attr('x2',161.5).style('stroke','black');
height_female.append('circle').attr('cx',161.5).attr('r',3);
height_female.append('text').attr('y',20).text("台灣女生平均身高161.5cm");
// 數值為0的屬性可省略